function s = lesion_dots_settings_P6_Orzo
...
s.stimulus.durStim = .475; %default stimulus duration
s.stimulus.delta_durStim = 0.025; %step size for duration adjustments
