function s = lesion_dots_settings_P3_Ricotta
%This phase adjusts the dot density and dot size 

%%%these parameters can get changed
s.behavior.reward.amount = [0.0 0. 0.];
s.stimulus.dotSize = 1.5; %start size (deg)
s.stimulus.delta_size = .35; %step size for size (up/down key)
s.stimulus.dotDensity = 2.6; %start density (dots/deg^2)
